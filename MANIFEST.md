...
| D-020 | Model bake-off: 3 models on IT-Ops golden set. Deterministic scorers 1.00 across ALL (Claude/Qwen/Llama) — governance is model-independent | docs/model-eval-2026-08-19.md | 🟡 |
...
| D-024 | Pinecone vector backend behind retrieval contract (VECTOR_BACKEND=pinecone); in-memory stays zero-setup default; matches AIFW prod | agent/retrieval.py | ⬜ |
